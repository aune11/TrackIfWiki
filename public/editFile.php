<?php
/*
    $filename = "/PHPDirectory/index.php?page=includes" . DIRECTORY_SEPARATOR . rawurlencode($key); //"includes" . $directory . "/" . $filename . ".md"; //need directory here; use PID of page that was used to get here
    $fd = fopen($filename,"r");
            ...
            <div class="content">
                ...
                <form action="editSubmit.php" method="post">
                    <p>
                        ...
                        <span><input type="text" name="filename" value="" class="filename" placeholder="Document Title" /></span><br />
                    </p>
                    <p>                    
